...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "Test Card", "test.com");
        ...
        assertEquals("test.com", result.getShortUrl());
    }
}